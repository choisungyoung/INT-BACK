...
==== HTTP request
include::{snippets}/decommend-solution/path-parameters.adoc[]
include::{snippets}/decommend-solution/http-request.adoc[]

==== HTTP response
include::{snippets}/decommend-solution/http-response.adoc[]
